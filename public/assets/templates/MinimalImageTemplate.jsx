...
export default function MinimalImageTemplate({ data, accentColor }) {
      ...
      <div className="grid grid-cols-3">
        <div className="col-span-1 py-7">
          ...
          typeof data.personal_info.image === "string" ? (
            <div>
              <Image src={data.personal_info.image} alt="Profile" width={128} height={128} unoptimized className="w-32 h-32 object-cover rounded-full mx-auto" style={{ background: accentColor + "70" }} />
            </div>
          ) : data.personal_info?.image &&
            typeof data.personal_info.image === "object" ? (
            <div>
              <Image src={URL.createObjectURL(data.personal_info.image)} alt="Profile" width={128} height={128} unoptimized className="w-32 h-32 object-cover rounded-full mx-auto" />
            </div>
          ) : null}
        </div>
          ...
          <section className="mb-4">
            ...
            <div className="space-y-2 text-sm flex flex-col items-start justify-center">
              ...
              {data.personal_info?.email && (
                <div className="flex items-center gap-2">
                  <a target="_blank" href={`mailto:${data.personal_info?.email}`} className="flex items-center gap-2 break-all" >
              ...
              {data.personal_info?.linkedin && (
                <a target="_blank" href={data.personal_info?.linkedin.startsWith("https://") ? data.personal_info?.linkedin : `https://${data.personal_info?.linkedin}` } className="flex items-center gap-2" >
              ...
              {data.personal_info?.github && (
                <a target="_blank" href={data.personal_info?.github.startsWith("https://") ? data.personal_info?.github : `https://${data.personal_info?.github}` } className="flex items-center gap-2" >
              ...
              {data.personal_info?.website && (
                <a target="_blank" href={data.personal_info?.website.startsWith("https://") ? data.personal_info?.website : `https://${data.personal_info?.website}` } className="flex items-center gap-2" >
                            ...
                            {cert.credential_url ? (
                              <div className="flex items-center">
                                ...
                                <a href={cert.credential_url} target="_blank" rel="noopener noreferrer" >
                                  <ExternalLink size={12} className="ml-1 opacity-75 shrink-0" />
                                </a>
                              </div>
                            ) : (
                              cert.certificate_name
