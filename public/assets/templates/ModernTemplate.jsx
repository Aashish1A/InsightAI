...
export default function ModernTemplate({ data, accentColor }) {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white text-gray-800">
      {/* Header */}
      <header className="px-7 py-3 text-white" style={{ backgroundColor: accentColor }} >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 text-sm">
          {data.personal_info?.email && (
            <div className="flex items-center gap-2">
              <a target="_blank" href={`mailto:${data.personal_info?.email}`} className="flex items-center gap-2" >
